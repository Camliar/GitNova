...
> 当前仓库已包含可执行的 Core 协议、本地 Git 读模型，以及 Core-owned GitHub repository/PR detail 与 original commits；remote per-commit diff、Squash Trace 和 Desktop 主路径将由后续独立 Task 实现。
