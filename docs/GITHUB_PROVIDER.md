...
The initial adapter deliberately excludes GitHub Enterprise, direct REST/GraphQL transport, login flows, PR data, original commits, and Squash Trace. Those are separate Tasks behind the same Core-owned Provider boundary.
