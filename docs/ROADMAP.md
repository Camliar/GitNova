...
Desktop Host 基座、独立 Core transport、仓库/PR 导航、commit graph、original commit diff 与 Squash Trace 关系呈现已经建立；Core staged commit 与 local branch mutations 也已具备。后续 MVP Task 接入 Desktop mutation workflow 与交付质量。
