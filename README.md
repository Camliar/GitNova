...
> 当前仓库已包含可执行的 Core 协议、本地 Git 读模型，以及 Core-owned GitHub repository/PR detail、original commits、member commit 文件/行级 diff 与可解释 Squash Trace relationship；Desktop 主路径将由后续独立 Task 实现。
