...
> 当前仓库已包含可执行的 Core 协议、本地 Git 读模型与首个 Core-owned GitHub repository metadata adapter；Branch 写操作、Desktop graph、PR original commits 和 Squash Trace 将由后续独立 Task 实现。
