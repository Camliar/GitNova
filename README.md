...
> 当前仓库已包含可执行的 Core 协议骨架，但不包含 Repository、Status、Commit、Diff、Branch、Graph、GitHub API、PR 或 Squash Trace 等业务功能。
...
阅读[项目总览](docs/PROJECT.md)、[产品需求](docs/PRODUCT_REQUIREMENTS.md)、[Core 协议](docs/PROTOCOL.md)、[仓库发现](docs/REPOSITORIES.md)和[贡献指南](CONTRIBUTING.md)，再从 `tasks/` 选择已批准的 Task。
